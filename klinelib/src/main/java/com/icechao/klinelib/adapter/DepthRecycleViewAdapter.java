...
//        this.rightMax = rightMax;
    ...
    public void onBindViewHolder(DepthRecycleViewAdapter.DepthViewHolder viewHolder, int i) {
        ...
        LogUtil.e("left.getProgress() :   " + left.getProgress());
        LogUtil.e("right.getProgress() :   " + right.getProgress());


//        viewHolder.progressLeft.setMax(right.getLength());
//        viewHolder.progressRight.setMax(right.getLength());
